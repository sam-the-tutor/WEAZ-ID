...
const HomePage = () => {
  ...
  const { login, isAuthenticated,weazIDActor} = useAuth();
  console.log("actor :",weazIDActor)
  return (
    < >
        ...
        <Grid item display="flex" textAlign="center" mt="20px" justifyContent="center" alignContent="center"
         xs={12}>
        <Grid item  >
          <BasicModal/>
          </Grid>
